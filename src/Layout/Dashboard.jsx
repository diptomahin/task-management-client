        ...
        <div className="flex">
            <div className="w-64 min-h-screen bg-gradient-to-r from-[#8C52FF] via-purple-500 to-[#00BF63] pt-10">
                <ul className="menu p-4 text-lg">
                    <>
                        <li className="font-bold"><NavLink to='/dashboard/task' style={({ isActive }) => {
                            return {
                        ...
                        <li className="font-bold"><NavLink to='/dashboard/tasklist' style={({ isActive }) => {
                            return {
                                color: isActive ? "black" : "white",
                                backgroundColor: isActive ? "white" : " ",
                                padding: isActive ? "10px" : " ",
                        ...
                        }}><CiCircleList /> To-do list</NavLink></li>
                    </>
                </ul>
