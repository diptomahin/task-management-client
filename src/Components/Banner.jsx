...
const Banner = () => {
    return (
        <div className="hero min-h-screen py-24 bg-gradient-to-r from-[#8C52FF] via-purple-500 to-[#00BF63]">
            <div className="hero-content  flex flex-col-reverse md:flex-row">
                <div className="md:ml-10 ">
                    ...
                    <Link to='/dashboard'><button className="btn bg-white text-2xl hover:bg-gradient-to-r from-[#8C52FF] via-purple-500 to-[#00BF63] hover:text-white">Let’s Explore</button></Link>
                </div>
